...
-- TODO: Make normal maps for doe valley, valley point and west riverside
local function initRoadMapStyle(mapUI)
	local mapAPI = mapUI.javaObject:getAPIv1()
	local styleAPI = mapAPI:getStyleAPI()

	local r,g,b = 219/255, 215/255, 192/255
	-- local r,g,b = 20/255, 20/255, 40/255
	...
	-- local yellow_r, yellow_g, yellow_b = 170, 128, 15;
...
LootMaps.Init.RoadMapLouisville = function(mapUI)
	local x1 = cellSize * 39;
	local y1 = cellSize * 3;
	local x2 = cellSize * 50;
	local y2 = cellSize * 13;
...
LootMaps.Init.RoadMapValleyStation = function(mapUI)
...
LootMaps.Init.RoadMapWestPoint = function(mapUI)
	local x1 = cellSize * 29;
	local y1 = cellSize * 21;
	local x2 = cellSize * 43;
	local y2 = cellSize * 26;
...
LootMaps.Init.RoadMapMarchRidge = function(mapUI)
	local x1 = cellSize * 31;
	local y1 = cellSize * 37;
	local x2 = cellSize * 43;
	local y2 = cellSize * 44;
...
LootMaps.Init.RoadMapRosewood = function(mapUI)
	local x1 = cellSize * 17;
	local y1 = cellSize * 37;
	local x2 = cellSize * 32;
	local y2 = cellSize * 44;
...
LootMaps.Init.RoadMapMuldraughEast = function(mapUI)
	local x1 = cellSize * 35;
	local y1 = cellSize * 26;
	local x2 = cellSize * 43;
	local y2 = cellSize * 38;
...
LootMaps.Init.RoadMapMuldraughWest = function(mapUI)
	local x1 = cellSize * 29;
	local y1 = cellSize * 26;
	local x2 = cellSize * 36;
	local y2 = cellSize * 38;
...
LootMaps.Init.RoadMapRiversideEast = function(mapUI)
	local x1 = cellSize * 17;
	local y1 = cellSize * 16;
	local x2 = cellSize * 27;
	local y2 = cellSize * 26;
...
LootMaps.Init.RoadMapRiversideWest = function(mapUI)
	local x1 = cellSize * 10;
	local y1 = cellSize * 16;
	local x2 = cellSize * 18;
	local y2 = cellSize * 26;
...
LootMaps.Init.RoadMapDoeValleyWest = function(mapUI)
	local x1 = cellSize * 10;
	local y1 = cellSize * 24;
	local x2 = cellSize * 22;
	local y2 = cellSize * 38;
...
LootMaps.Init.RoadMapDoeValleyEast = function(mapUI)
	local x1 = cellSize * 20;
	local y1 = cellSize * 24;
	local x2 = cellSize * 30;
	local y2 = cellSize * 38;
...
-- LootMaps.Init.RoadMapBigE = function(mapUI)
-- 	local x1 = cellSize * 41;
-- 	local y1 = cellSize * 13;
-- 	local x2 = cellSize * 50;
-- 	local y2 = cellSize * 25;
...
-- LootMaps.Init.RoadMapBigCenter = function(mapUI)
-- 	local x1 = cellSize * 30;
-- 	local y1 = cellSize * 21;
-- 	local x2 = cellSize * 43;
-- 	local y2 = cellSize * 38;
...
-- LootMaps.Init.RoadMapBigS = function(mapUI)
-- 	local x1 = cellSize * 17;
-- 	local y1 = cellSize * 37;
-- 	local x2 = cellSize * 43;
-- 	local y2 = cellSize * 44;
...
-- LootMaps.Init.RoadMapBigW = function(mapUI)
-- 	local x1 = cellSize * 10;
-- 	local y1 = cellSize * 16;
-- 	local x2 = cellSize * 30;
-- 	local y2 = cellSize * 37;
